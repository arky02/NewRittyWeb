...
function Header({ modalState, setModalState }) {
  return (
    <div className="bg-[#FFF6F0] w-full md:w-[400px] h-fit border-b-[1px] px-[15px] md:py-[15px] py-[11px] flex md:relative items-center gap-[15px] font-bold justify-between fixed top-0 z-50">
